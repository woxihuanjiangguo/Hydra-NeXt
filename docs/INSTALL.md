...
- **STEP 5: Install ninja and packaging**
    ...
    ```
- **STEP 6: Install our repo and diffusers**
    ```
    pip install -v -e .
...
- **STEP 9: Download relevant files.**
    ```
    mkdir data; cd data;
    mkdir infos; cd infos;
    wget https://huggingface.co/Zzxxxxxxxx/HydraNeXt/blob/main/b2d_infos_train.pkl
    wget https://huggingface.co/Zzxxxxxxxx/HydraNeXt/blob/main/b2d_infos_val.pkl
    wget https://huggingface.co/Zzxxxxxxxx/HydraNeXt/blob/main/train_4096_t2d_latestv2.pkl
    wget https://huggingface.co/Zzxxxxxxxx/HydraNeXt/blob/main/b2d_map_infos.pkl
    ```
